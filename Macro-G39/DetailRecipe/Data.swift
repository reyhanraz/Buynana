...
let listResep = [
    ...
    Resep(jenisPisang: .Ambon, tingkatKematangan: .Kematengan, namaRecipe: "Lumpia roti goreng isi pisang selai kacang", description: "Cemilan lumpia berkulit roti, dilengkapi dengan kelezatan selai kacang di dalamnya.", gambarRecipe: "", bahanRecipe: [
        ...
        "Goreng pisang dengan margarin hingga matang. Lalu tipiskan roti tawar saya pake gelas.",
        "Oles roti dengan selai kacang. Letakkan pisang dan keju parut diatasnya, lipat roti jadi dua, tekan-tekan biar pinggirnya rekat.",
    ...
    "Buang tengahnya pisang kepok, haluskan",
        "Campur terigu, soda kue dan baking powder di wadah lain. Lalu ayak.",
